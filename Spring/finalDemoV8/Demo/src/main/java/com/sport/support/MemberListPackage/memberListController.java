...
public class memberListController {
	...
	public void destroyMemberList () {
		memberListRepository.deleteAll();

	}

//	@GetMapping(path="/delete/{id}")
//	public void deleteFromMemberList (@PathVariable(value="id") int id) {
//		memberList n = memberListRepository.findDistinctById(id);
//		
//		if(n != null)
//			memberListRepository.deleteById((long) id);
//
//	}
	...
	public @ResponseBody int getBranchId (@PathVariable(value="id") int id) {
		
		memberList n = memberListRepository.findDistinctByMemberId(id);
		if(n!=null)
			return n.getBranchId();
		return 0;
	}
	
	@GetMapping(path="/get/memberlist/{id}")
	public @ResponseBody memberList getListFromMemberId (@PathVariable(value="id") int id) {
